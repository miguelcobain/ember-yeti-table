...
var _dec, _dec2, _dec3, _dec4, _class, _descriptor, _descriptor2, _descriptor3, _descriptor4, _class2;
let Pagination = (_dec = localCopy('args.pageSizes', [10, 15, 20, 25]), _dec2 = localCopy('args.showInfo', true), _dec3 = localCopy('args.showPageSizeSelector', true), _dec4 = localCopy('args.showButtons', true), (_class = (_class2 = class Pagination extends Component {
  constructor(...args) {
    super(...args);
    // theme;
    // paginationData;
    ...
    _defineProperty(this, "isPaginationNumberSelected", helper(([number1]) => {
      return number1 === this.args.paginationData.pageSize;
    }));
    /**
  ...
  changePageSize(ev1) {
    this.args.paginationActions.changePageSize(ev1.target.value);
  }
  ...
  strictMode: true
}), _class2), _class2), (_descriptor = _applyDecoratedDescriptor(_class.prototype, "pageSizes", [_dec], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
